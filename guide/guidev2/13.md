...
export function useCreate{{resource}}() {
  return useMutation({
    ...
    // Do not invalidate here if using two-phase create + media (14c) — form invalidates after media.
...
export function useCreateArticle() {
  return useMutation({
    ...
    // Do not invalidate here — create + media is two-phase; form invalidates after media (14c).
    throwOnError: false, // Don't throw errors, let component handle them
  });
}
...
// Admin create hook: see 22-admin-create.md — do not invalidate in onSuccess when using two-phase media.
