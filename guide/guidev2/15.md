...
> Text-only form below. For file upload / MediaManager deltas, open `15{L}.md` after finishing this step.
...
## step 4 ~~edit form with file upload~~ (moved to 15{L}.md)

> Simple file upload deltas: `15b.md`. Complex MediaManager edit: `15c.md`. Path none: `15a.md`.

## step 5 admin edit form component

> Skip this step and step 12 if ADMIN=no. Text-only admin form below; file upload / MediaManager deltas in `15{L}.md`.
...
## step 6 ~~admin edit form with file upload~~ (moved to 15{L}.md)
...
<!-- NEXT: 15{L}.md then 16{L}.md (16.md is only a stub) -->
