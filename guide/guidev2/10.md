...
by the time i am writing this, there is only likes, views, comments, collections, reports, and notifications. there might be more or less when you currently read this. prompt human the available resource actions found (likes, views, comments, collections, reports, notifications, etc), ask which ones to apply/add.
