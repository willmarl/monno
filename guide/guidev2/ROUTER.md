...
| 10    | `10.md`                      | Only subsections for enabled resource actions (views→history; reports→REPORTABLE_RESOURCES) |
...
| 21    | `21.md`                      | Only subsections for enabled resource actions (views→history tabs; reports→ReportButton) |
