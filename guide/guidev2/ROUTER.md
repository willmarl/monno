...
| 10    | `10.md`                      | Only subsections for enabled resource actions (views includes history hydrate) |
...
| 21    | `21.md`                      | Only subsections for enabled resource actions (views includes /history + admin history tabs) |
