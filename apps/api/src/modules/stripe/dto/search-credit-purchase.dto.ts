...
export enum CreditPurchaseSearchFields {
  USERNAME = 'user.username',
}

const VALID_CREDIT_SEARCH_FIELDS = Object.values(CreditPurchaseSearchFields);
 ...
 */
export class CreditPurchaseSearchDto extends PaginationDto {
  @ApiPropertyOptional({
  ...
  getOrderBy(): Record<string, 'asc' | 'desc'> {
    ...
    const validFields = ['purchasedAt', 'amount', 'pricePaid'];
