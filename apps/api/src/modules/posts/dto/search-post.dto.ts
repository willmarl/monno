...
function PostSearchMixin<TBase extends new (...args: any[]) => {}>(
  Base: TBase,
) {
 ...
 */
export class PostSearchDto extends PostSearchMixin(PaginationDto) {}

/**
 * Search DTO for posts with cursor pagination
 * Extends CursorPaginationDto with search-specific parameters
 */
export class PostSearchCursorDto extends PostSearchMixin(CursorPaginationDto) {}
